...
\begin{center}
	...
	\citep{PeerlinckAmy2022MFEO} applied DEAP to solve a multi-objective knapsack problem. We adapted their algorithm to solve the ACLPP in each node of this work's solution.
		
Our algorithm is not complete, as we did not include the constraints regarding the weight and balance problem or the pickup and delivery problem.
...
Up to this point in time, we had no success solving the ACLPP with DEAP.
...
The code implemented is available in {\tt //github.com/celiomesquita/ACLP\_RPDP\_P/blob/main/tsp\_deap.py}.
	...
	\begin{figure}[H]
		\centering
		\caption{\label{fig:brazil} {\it Shims/GA} best tour (may not be optimal)}
