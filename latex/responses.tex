...
\begin{center}
	\begin{minipage}{10cm}
		...
		{\color{blue}
		We included the figure below and its description to depict the main algorithm for easy understanding of the main flow.
		}
		...
		%% Make the boxes
\node [mybox] (first)                        { \small {\bf Select:}\\ \small 1. scenario\\ \small 2. surplus\\ \small 3. time limit};
\node [mybox, right=0.7cm of first] (second) { \small {\bf Config:}\\ \small 4. parameters\\ \small 5. cost matrix\\ \small 6. pallets\\ \small 7. items};
\node [mybox, right=0.7cm of second] (third) { \small {\bf Define tour}\\  \small {\bf schema:}\\ \small 8. All K! tours\\ \ \ \  \small or\\ \small 8. Solve a TSP\\ \small  \ \ \ (set of tours))};
\node [mybox, right=0.7cm of third] (fourth) { \small {\bf Solve ACLPP+RPDP:}\\ \small 9. Many tours\\ \small  \ \ \ (node-by-node)\\ \small 10. Select best tour};
