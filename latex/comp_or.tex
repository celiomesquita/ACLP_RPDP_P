...
\multirow{6}{*}{$1.2$}&\multirow{1}{*}{$Gurobi^*$}& $f$ upper bound & {\it 12.00} & {\it 8.22} & {\it 12.18} & {\it } &  {\it }      & {\it }      &   \\% $


%                      \cmidrule{2-10}		                       
%                      &\multirow{2}{*}{ $Gurobi$}& $f$               & {\bf 12.00} & {\bf 8.28} & {\bf 12.19} & {\bf 13.38} &  14.41      &  13.25      &   \\%
%                      &                          & {\bf run-time (s)}&  80          &   19       &  35         &  133        &    325      &  1719       &   \\%

                      \cmidrule{2-10}		                       
                      &\multirow{2}{*}{ $Shims$} & $f$               & 8.33        &  6.52      &  7.47       &  8.17       &   7.79      & 6.74        & \\%
                      &                          & {\it run-time (s)}&  < 1        &   3        &    5        &   21        &   58        &  342        &\\%

                      \cmidrule{2-10}		                       
                      &\multirow{2}{*}{ $mpShims$}& $f$               & 11.87        &  7.28      &  9.90      & 11.81       & {\bf 14.53} & {\bf 13.74} &   \\%
...
\end{tabular}
\textsuperscript{$Gurobi^*$ had variables integrality relaxed and was run with a time limit of 60s per node.}	
\normalsize
\end{table}
