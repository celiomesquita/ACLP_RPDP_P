...
\begin{algorithm}[H]
	\caption{$getBestNPP(procs, scores, runtimes)$}  \label{alg:bestnum}
	\begin{algorithmic}[1]
		...
		\For{$i$ in $procs$}
			...
			\State $h = \sqrt{x^2 + y^2}$, distance from {\it Utopia}
			\If{$minD$ > $h$}
				\State $minD \gets h$
...
\multirow{3}{*}{\it {mpShims}} &$1.2$& 6       & 2     & 0     & 0     & 0     & 0    \\ 
                               &$1.5$& 4       & 4     & 0     & 0     & 0     & 0    \\
                               &$2.0$& 0       & 0     & 0     & 0     & 0     & 0    \\
\midrule[.1pt]

\multirow{3}{*}{\it {mpACO}}   &$1.2$& 4       & 2     & 0     & 0     & 0     & 0    \\ 
                               &$1.5$& 6       & 1     & 0     & 0     & 0     & 0    \\ 
                               &$2.0$& 0       & 0     & 0     & 0     & 0     & 0    \\                               
\bottomrule		
\end{tabular}
...
Table \ref{tab:numProcs} presents the best numbers of parallel processes for each method, scenario, and volume surplus.
