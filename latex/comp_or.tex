...
Communication between processes can be achieved via {\it multiprocessing.Queue} and {\it multiprocessing.Pipe} which permits regular inter-process communication -IPC. (\cite{multiprocessing}).
