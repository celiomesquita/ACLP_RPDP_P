...
%	\footnotesize
	...
	\toprule
	\textbf{Scenario} & $method$ &{\bf Results}     & \textbf{1} & \textbf{4} & \textbf{8} & \textbf{16} & \textbf{24} & \textbf{32}  \\
	\toprule
	\multirow{4}{*}{\bf {1}}  &\multirow{2}{*}{\it {mpShims}}  &$f$               & 1 & 4 & 8 & 16 & 24 & 32 \\
	                          &                                &{\bf run-time (s)}& 1 & 4 & 8 & 16 & 24 & 32 \\
                              \cmidrule{2-9}
	                          &\multirow{2}{*}{\it {mpACO}}    &$f$               & 1 & 4 & 8 & 16 & 24 & 32 \\
	                          &                                &{\bf run-time (s)}& 1 & 4 & 8 & 16 & 24 & 32 \\
	\cmidrule{1-9}
	\multirow{4}{*}{\bf {2}}  &\multirow{2}{*}{\it {mpShims}} &$f$               & 1 & 4 & 8 & 16 & 24 & 32 \\
	                          &   &{\bf run-time (s)}& 1 & 4 & 8 & 16 & 24 & 32 \\
                              \cmidrule{2-9}
	                          &\multirow{2}{*}{\it {mpACO}}   &$f$               & 1 & 4 & 8 & 16 & 24 & 32 \\
	                          &   &{\bf run-time (s)}& 1 & 4 & 8 & 16 & 24 & 32 \\				
...
\scriptsize
	\begin{tabular}{r|c|c|cccccc|c}
		...
		\multirow{2}{*}{\it {ACO}}     &\multirow{2}{*}{\bf {1}} & $f$              & 5.77        & 3.49    &          &        &       &      &   \\ 
                                       &                         &{\bf run-time (s)}& 14          & 808     &           &        &       &      &   \\ 
        \midrule[.1pt]	
