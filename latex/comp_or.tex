...
Below, we present five implementations for $SolveNode$: the first using a MIP solver, and four with developed heuristics: {\it Ant Colony Optimization}\/ (ACO), {\it Multiprocessed Ant Colony Optimization}\/ ({\it mpACO}),  and {\it Shims},  and {\it Multiprocessed Shims (mpShims)}.
