...
We ran Algorithm \ref{alg:main} in the 6 scenarios described in Table \ref{tab:scenarios}, considering 3 methods for node-by-node resolution: {\it Gurobi}, {\it Shims} (Algorithm \ref{alg:shims}), and {\it mpShims} (Algorithm \ref{alg:mpshims}).
...
\midrule
\multirow{7}{*}{$2.0$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 16.49       & {\bf 11.60} & {\bf 16.68} & 18.33       &  20.10      & 17.94        &   \\%
&                                                & {\it run-time (s)} &  12         &   25        &  45         &  169        &   437       &  2377        &   \\%

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 12.53       &  8.31       &  10.04      &  10.94      &   11.72     & 10.13        & \\%
&                                                & {\it run-time (s)} &  < 1        &  3          &    6        &   24        &   70        &  419         &\\%

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 16.71} & 10.86       & {\bf 16.68} & {\bf 18.84} & {\bf 21.30} & {\bf 19.39}  &   \\%
&                                                & {\it run-time (s)} &  < 1        &  2          &    3        &   9         &   26        &   158        &   \\%
...
For {\it Gurobi} in some scenarios, less than 50\% of the results were optimal, and the remaining were suboptimal due to the time limit. This explains that {\it mpShims} surpassed {\it Gurobi} results. 
