...
\multirow{6}{*}{$1.2$}&\specialcell{$Relaxed$\\$Gurobi$}& $f$         &{\it 11.22}   &{\it 7.88}   &{\it 10.25} &{\it 13.34}  &{\it 14.30}   &{\it 12.92}       & 1.00 \\% 6845

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 9.66         &  6.38       &  9.55       &  11.12      &  12.37      &   12.03      & 0.89 \\% 6111
&                                                & {\it run time (s)} &  < 1         &  5          &    11       &   43        &  128        &  835         &  1.0 \\% 1023

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & 11.03        & 7.43        & 10.05       & 13.08       & 14.02       &  12.66       & 0.99\\% 6827

&                                                & {\it run time (s)} &  < 1         &  2          &    4        &  15         &  47         & 295          &  {\bf 2.8}\\% 364

\midrule

\multirow{6}{*}{$1.5$}&\specialcell{$Relaxed$\\$Gurobi$}& $f$         &{\it 15.17}   &{\it 10.98}  &{\it 17.80}  &{\it 16.92}  &{\it 19.63}   &{\it 18.62}  & {\it 1.00} \\% 9912

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 13.70        &  9.07       &  13.70      &  15.43      &   17.19     &  17.24       & 0.87 \\%8633
&                                                & {\it run time (s)} &  < 1         &  4          &    7        &   26        &   81        &  520         & 1.0\\% 639

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & 14.82        & 10.45       & 17.45       &{\bf 16.92}  & 19.27       & 18.30        & 0.98\\%9721
&                                                & {\it run time (s)} &  < 1         &  2          &    3        &    12       &   38        &   236        & {\bf 2.2}\\% 292

\midrule
\multirow{6}{*}{$2.0$}&\specialcell{$Relaxed$\\$Gurobi$}& $f$         &{\it 23.11}   &{\it 16.74}  &{\it 23.63}  &{\it 24.33}  &{\it 26.22}  &{\it 25.80}   & {\it 1.00} \\% 13983

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                &   20.42      &   13.90     &  20.30      &  22.96      &   25.28     &   24.81      & 0.91\\% 12767
&                                                & {\it run time (s)} &  2           &  9          &    17       &   68        &   206       &  1216        & 1.0\\% 1518

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                &  22.66       &  15.41      &  23.17      &  23.37      &  23,91      &  25.25       &  0.96\\% 13377
&                                                & {\it run time (s)} &  2           &  3          &    5        &   20        &   64        &  398         & {\bf 2.8}\\% 544
...
\begin{table}[H]
	\centering
	\caption{Volume surpluses, methods and scenarios results}  \label{tab:results2}
	\footnotesize
	%\scriptsize
	\begin{tabular}{crcccccccc}
		\toprule
		...
		\multirow{6}{*}{$1.2$}&\specialcell{$Relaxed$\\$Gurobi$}& $f$         &{\it 12.02}   &{\it 8.74}   &{\it 12.56} &{\it 14.34}  &{\it 14.79}   &{\it 13.49}       & 1.00 \\% 
		
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}                       & $f$                &  10.34       & 8.50        & 12.42      &  15.06      &  15.97       &  15.88       &   \\% 
		&                                                & {\it run time (s)} &  < 1         &  3          &  5         &   20        &  58          &  352         &  1.0 \\% 
		
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}                     & $f$                &  11.76       &  8.57       & 12.28      &  14.02      &  14.50       & 13.23        & \\% 
		
		&                                                & {\it run time (s)} &  < 1         &  2          &  3         &   47        &  33          & 193         &  {\bf 2.8}\\% 
		...
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}                       & $f$                &         &         &       &        &        &         &  \\%8633
		&                                                & {\it run time (s)} &  < 1         &  4          &    7        &   26        &   81        &  520         & 1.0\\% 639
		
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}                     & $f$                &         &        &        &  &        &         & \\%9721
		&                                                & {\it run time (s)} &  < 1         &  2          &    3        &    12       &   38        &   236        & {\bf 2.2}\\% 292
		...
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}                       & $f$                &         &        &        &        &        &         & \\% 12767
		&                                                & {\it run time (s)} &  2           &  9          &    17       &   68        &   206       &  1216        & 1.0\\% 1518
		
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}                     & $f$                &         &        &        &        &        &         &  \\% 13377
		&                                                & {\it run time (s)} &  2           &  3          &    5        &   20        &   64        &  398         & {\bf 2.8}\\% 544
...
The upper bound is the objective function value of a linear programming relaxation of the problem, demonstrating that no integer viable solution can have an objective value greater than this.
...
% \ref{eq:distobj} to \ref{eq:disttorque}
