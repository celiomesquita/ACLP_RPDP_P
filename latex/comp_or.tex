...
\multirow{7}{*}{$1.2$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 12.00       & {\bf 8.38}  & {\bf 12.19} & 13.38       &  14.42      & 13.25        &   \\%
&                                                & {\it run-time (s)} &  8          &   14        &  25         &  95         &    217      &  1719        &   \\%

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 8.37        &  6.40       &  7.68       &  8.05       &   7.72      & 6.74         & \\%
&                                                & {\it run-time (s)} &  < 1        &  < 1        &    3        &   11        &   27        &  342         &\\%

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 12.24} &  7.95       &  11.59      & {\bf 13.80} & {\bf 16.16} & {\bf 13.74}  &   \\%
&                                                & {\it run-time (s)} &  < 1        &  < 1        &    2        &   6         &    15       &   165        &   \\%

\midrule

\multirow{7}{*}{$1.5$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 16.49       & 0        & 0 & 13.38       &  0      & 0        &   \\%
&                                                & {\it run-time (s)} &  12         &   14        &  25         &  95         &    217      &  1719        &   \\%
...
\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 16.59} & {\bf 10.49} &  16.82      & 18.46        & 22.19      & {\bf 0}  &   \\%
&                                                & {\it run-time (s)} &  < 1        &  2          &    3        &   10         &   27       &   165        &   \\%
...
For {\it Gurobi} in {\bf Scenario 1}, 50\% of the results were optimal, but the remaining were suboptimal due to the time limit. This explains that {\it mpShims} surpassed {\it Gurobi} results. The same applies to scenarios 4, 5 and 6, where {\it Gurobi} obtained less than 30\% optimal results.
