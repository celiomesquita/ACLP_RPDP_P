...
\multirow{6}{*}{$1.2$}&\multirow{1}{*}{ $Gurobi$}& $f$                &{\bf 11.22}   &{\bf 7.88}   & 10.25      & 11.02       & 11.88        & 12.92       & 0.90 \\% 6484    7222

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 9.66         &  6.38       &  9.55       &  11.12      &  12.37      &   12.03      & 0.85 \\%6111
&                                                & {\it run-time (s)} &  < 1         &  5          &    11       &   43        &  128        &  835        &  1.0 \\%1023

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & 11.03        & 7.43        &{\bf 12.58}  &{\bf 13.08}  &{\bf 14.02}  & {\bf 13.44}  &  {\bf 0.99}\\%7158

&                                                & {\it run-time (s)} &  < 1         &  2          &    4        &  15         &  47         & 295          &  {\bf 2.8}\\%364

\midrule

\multirow{6}{*}{$1.5$}&\multirow{1}{*}{ $Gurobi$}& $f$                &{\it 14.45}   &{\bf 10.98}   &{\it 15.59}  &{\it 16.92}  &{\it 18.63}   &{\it 17.62}  & {\it 1.00} \\% 6607
...
\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 14.82} & 10.45       & {\bf 17.45} & 16.92       & 19.27       & {\bf 18.30}  & 0.98\\%
&                                                & {\it run-time (s)} &  < 1        &  2          &    3        &   10        &   28        &   173        & {\bf 14.1}\\%

\midrule
\multirow{6}{*}{$2.0$}&\multirow{1}{*}{ $Gurobi$}& $f$                &{\it 0}   &{\it 0}   &{\it 0}  &{\it 0}  &{\it 0}   &{\it 0}  & {\it 1.00} \\% 6607
