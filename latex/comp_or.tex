...
\begin{table}[H]
	...
	\begin{tabular}{crcccccccc}
		...
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}                     & $f$                &     11.73 &     7.57  &     12.05 &     12.95 &     13.94 &     13.62 & 0.88 \\% 7186
		
		&                                                & {\it run time (s)} &     < 1   &     2     &     3     &     16    &     33    &     193   &  {\bf 1.8}\\% 248
		
		\midrule
		
		
		\multirow{6}{*}{$1.5$}&\specialcell{$Relaxed$\\$Gurobi$}& $f$         &{\it }&{\it  } &{\it  }&{\it  }&{\it  }&{\it  }&  \specialcell{{\bf 1.00}\\-} \\%  

        \cmidrule{2-10}		                       
        &\multirow{2}{*}{ $Shims$}                       & $f$                &     14.68 &   12.21   &  17.67    &  21.01    &  22.64    &       &    \\% 
        &                                                & {\it run time (s)} &     < 1   &     2     &     3     &     12    &     33    &        &  1.0 \\% 

        \cmidrule{2-10}		                       
        &\multirow{2}{*}{ $mpShims$}                     & $f$                &       &        &       &       &       &       &   \\% 7186
        &                                                & {\it run time (s)} &     < 1   &     2     &     3     &     16    &     33    &     193   &  {\bf 1.8}\\% 248
...
There was some expectation on this post-improvement method as it could have minimized the distances of travel of the pallets to the ramp door, but unfortunately, there was no alteration to these distances.
