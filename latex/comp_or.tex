...
\multirow{7}{*}{$1.2$}&\multirow{2}{*}{ $Gurobi$}& $f$                & {\bf 12.00} & {\bf 8.38}  & {\bf 12.19} & {\bf 13.38} & {\bf 14.42} & 13.25        & {\bf 0.99} \\% 7412
&                                                & {\it run-time (s)} &  8          &   14        &  25         &  95         &    217      &  1719        &  1.0       \\%2078

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 9.66        &  6.37       &  9.58       &  10.87      &   12.24     & 11.94        &  0.82\\%
&                                                & {\it run-time (s)} &  < 1        &  3          &    5        &   11        &   27        & 342          &  5.3\\%389
...
\multirow{7}{*}{$1.5$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 16.49       & {\bf 11.60} & {\bf 16.68} & {\bf 18.33} & {\bf 20.10} & 17.94        & {\bf 0.99}\\%10209
...
\midrule
\multirow{7}{*}{$2.0$}&\multirow{2}{*}{ $Gurobi$}& $f$                & {\bf 24.04} & {\bf 17.33} & {\bf 24.62} & {\bf 26.36} & {\bf 28.88} & {\bf 25.89}  & {\bf 1.00}\\%14712
&                                                & {\it run-time (s)} &  14         &   34        &  62         &  236        &  609        & 3431         & 1.0\\%4836
