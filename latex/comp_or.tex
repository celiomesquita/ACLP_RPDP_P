...
\begin{figure}[H]
	\begin{center}
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpShims1data20.csv};
				
				\legend{\it parallel processes}
			\end{axis}
		\end{tikzpicture}%
		~%
		%
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpShims2data20.csv};
	...
	\label{fig:mpShims2data20}
\end{figure}

Observing Figure \ref{fig:mpShims2data20}, it may be noticed that the best number of processes for {\it Scenario 1} (closest to the upper left corner) is \textbf{1}. For {\it Scenario 2}, the best number is \textbf{4}.
...
\begin{figure}[H]
	\begin{center}
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpShims1data50.csv};
		...
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpShims2data50.csv};
	...
	\label{fig:mpShims2data50}
\end{figure}

Observing Figure \ref{fig:mpShims2data50}, it may be noticed that the best number of processes for {\it Scenario 1} is \textbf{1}. For {\it Scenario 2}, the best number is \textbf{8}.
...
\begin{figure}[H]
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpACO1data20.csv};
		...
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpACO2data20.csv};
	...
	\label{fig:mpACO2data20}
\end{figure}

Observing Figure \ref{fig:mpACO2data20}, it may be noticed that the best number of processes for {\it Scenario 1} is \textbf{40}. For {\it Scenario 2}, the best number is \textbf{1}.
...
\begin{figure}[H]
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpACO1data50.csv};
		...
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {mpACO2data50.csv};
	...
	\label{fig:mpACO2data50}
\end{figure}

Observing Figure \ref{fig:mpACO2data50}, it may be noticed that the best number of processes for {\it Scenario 1} is \textbf{1}. For {\it Scenario 2}, the best number is \textbf{16}.
...
\scriptsize
	\begin{tabular}{r|c|c|cccccc|c}
		...
		\multirow{2}{*}{\it {mpShims}} &\multirow{2}{*}{\bf {24}}& $f$              & 5.88        & 3.16    & 3.16         &          &          &         &   \\ 
        ...
        \multirow{2}{*}{\it {mpACO}}   &\multirow{2}{*}{\bf {32}}& $f$              & 5.82        & 3.12    &          &         &       &       &   \\ 
