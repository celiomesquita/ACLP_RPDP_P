...
Observing Figure \ref{fig:mpShimsdata20}, it may be noticed that the best number of processes for {\it Scenario 1} (closest to the upper left corner) is \textbf{1}. For {\it Scenario 2}, the best number is \textbf{4}.
...
Observing Figure \ref{fig:mpShimsdata50}, it may be noticed that the best number of processes for {\it Scenario 1} is \textbf{1}. For {\it Scenario 2}, the best number is \textbf{8}.
...
Observing Figure \ref{fig:mpACOdata20}, it may be noticed that the best number of processes for {\it Scenario 1} is \textbf{40}. For {\it Scenario 2}, the best number is \textbf{1}.
...
Observing Figure \ref{fig:mpACOdata50}, it may be noticed that the best number of processes for {\it Scenario 1} is \textbf{1}. For {\it Scenario 2}, the best number is \textbf{16}.
