...
%\cite{Gueret2003} proposed a method for loading military aircraft (specifically, the french military) for airlift operations. They used a two-phased solution method consisting of heuristics that quickly compute suboptimal initial solutions for a 2-dimensional bin packing and a local search algorithm to improve upon the initial solution, while ignoring the aircraft center of gravity.
...
\newcolumntype{C}{>{\raggedright}p{0.18\textwidth}}
\newcolumntype{D}{>{\raggedright\arraybackslash}p{0.82\textwidth}}
...
\begin{table}[H]
	...
	\begin{tabular}{c|c|cccccc|c}
		...
		\multirow{2}{*}{\textbf{ACO}}     & $f$             & 21.93       & {\bf 6.77}& 8.85      & 9.65       & 11.75      & 11.54      &  0.934 \\ %21.927   &   19.65s
		                                  &{\bf runtime (s)}& 20          & 4        & 17       & 86        & 513       & 3,596     &  2.714 \\ 
		\midrule[.1pt]	
		
		
		\multirow{2}{*}{\textbf{Shims}}   & $f$             & 22.28       & {\bf 6.77} & 8.92     & 9.60       & 11.78      & 11.61      &  0.948       \\ 
		                                  &{\bf runtime (s)}& <1         & 2         & 8       & 31        & 166       & 1,087     &  {\bf 8.856} \\ 

		\midrule[.1pt]
		
		\multirow{2}{*}{\textbf{ACO-mp}}  & $f$             & 9.43       & {\bf 6.77}& 8.85      & 9.65       & 11.75      & 11.54      &  0.934 \\ 
                                          &{\bf runtime (s)}& 3         & 4        & 17       & 86        & 513       & 3,596     &  2.714 \\ 
        \midrule[.1pt]	

        \multirow{2}{*}{\textbf{Shims-mp}} & $f$             & 10.18       & {\bf 6.77} & 8.92     & 9.60       & 11.78      & 11.61      &  0.948       \\ 
                                           &{\bf runtime (s)}& $< 1$         & 2         & 8       & 31        & 166       & 1,087     &  {\bf 8.856} \\ 
