...
We also created a process-based parallel computing heuristic that quickly finds good solutions for a wide range of problem sizes, an essential contribution as it surpassed all Shims results and some of the Gurobi results, all methods under a time limit.
...
\multirow{7}{*}{$1.2$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 12.00       & {\bf 8.38} & {\bf 12.19} & 13.38       &  14.42      &           &   \\%
