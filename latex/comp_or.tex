...
\begin{table}[H]
	...
	\begin{tabular}{l|c|cccccc|c}
		...
		\multirow{2}{*}{\textbf{Shims}}   & $f$              & 6.47        & 3.90        & 3.30         & 3.25         & 3.13         & 6.03        &   \\ 
		                                  &{\bf run-time (s)}& <1          & 1           & 2            & 18           & 46           & 138         &   \\ %206s
		\midrule[.1pt]	
		
		\multirow{2}{*}{\textbf{Shims-p}} & $f$              & 6.47        & 3.90        & 3.30         & 3.25         & 3.13         & 6.03        &   \\ 
		                                  &{\bf run-time (s)}& 3           & 4           & 3            & 12           & 64           & 213         &   \\ %299s
		\midrule[.1pt]
		
		\multirow{2}{*}{\textbf{ACO}}     & $f$              & 6.19        & 3.63        & 3.21         &        &       &      &   \\ 
                                          &{\bf run-time (s)}& 5           & 239         & 572          &        &       &      &   \\ 
        \midrule[.1pt]	

        \multirow{2}{*}{\textbf{ACO-p}}   & $f$              & 6.04        & 4.23        & 3.61         &         &       &       &   \\ 
                                          &{\bf run-time (s)}& 3           & 72          & 196          &         &       &       &   \\ 
