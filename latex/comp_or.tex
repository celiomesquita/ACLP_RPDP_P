...
\begin{table}[H]
	...
	\begin{tabular}{crcccccccc}
		...
		\midrule
		\multirow{6}{*}{$2.0$}&\specialcell{$Relaxed$\\$Gurobi$}& $f$         &{\it 24.56}&{\it 17.47}&{\it 25.19}&{\it 27.94}&{\it  }&{\it  }&  \specialcell{{\bf 1.00}\\-} \\%11495  
		
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}                       & $f$                &    21.31  &  17.35    &   24.24   &   27.39    &  29.31     &  27.06     &     \\%  11012
		&                                                & {\it run time (s)} &     < 1   &     2     &     4     &     14     &     35     &   220     &  1.0 \\% 260
		
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}                     & $f$                &    24.33  &   17.26   &   24.70   &  24.81     &   27.71    &  24.93        &    \\% 9966
...
There was some expectation on this post-improvement method as it could have minimized the distances of travel of the pallets to the ramp door, but unfortunately, after running all scenarios and problem instances, there was no improvement in minimizing these distances.
