...
\multirow{6}{*}{$1.2$}&\multirow{1}{*}{ $Gurobi$}& $f$                &{\it 11.22}   &{\it 7.88}   &{\it 10.25} &{\it 13.34}  &{\it 14.30}   &{\it 12.92}       & 1.00 \\% 6845
...
\multirow{6}{*}{$1.5$}&\multirow{1}{*}{ $Gurobi$}& $f$                &{\it 14.45}   &{\it 10.98}   &{\it 15.59}  &{\it 16.92}  &{\it 18.63}   &{\it 17.62}  & {\it 1.00} \\% 6607
...
\midrule
\multirow{6}{*}{$2.0$}&\multirow{1}{*}{ $Gurobi$}& $f$                &{\it 21.47}   &{\it 16.74}   &{\it 22.81}  &{\it 24.33}  &{\it 26.22}   &{\it 25.08}  & {\it 1.00} \\% 6607
