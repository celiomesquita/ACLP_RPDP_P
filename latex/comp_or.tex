...
\begin{table}[H]
	...
	\begin{tabular}{crcccccccc}
		...
		\multirow{10}{*}{$1.2$} &\multirow{2}{*}{ $Shims$}   & $f$                & 0.72  &       &        &       &       &       &   \\% 0.722	0.210
                               &                            & {\bf run-time (s)} & < 1   &       &        &       &       &       &   \\%\cmidrule{2-10}
		
		                       &\multirow{2}{*}{ $mpShims$} & $f$                & 0.72  & 3.09  & 2.94  & 2.90  & 2.79  & 5.70  & 0.91  \\%2312
		                       &                            & {\bf run-time (s)} & < 1   & 3     & 7     & 26    & 97    & 267   & 70  \\%390
		                       
		                       \cmidrule{2-10}
		                       &\multirow{2}{*}{ $ACO$}     & $f$                & 2.88  & 3.78  & 3.19  & 3.17  & 2.97  & 5.87  & 1.00  \\ %2.850   29.488
                               &                            & {\bf run-time (s)} & 15    & 282   & 314   & 1334  & 6945  & 18883 & 1  \\ %27162
		\cmidrule{2-10}		                       
							   &\multirow{2}{*}{ $mpACO$}   & $f$                & 2.62  & 3.94  & 3.17  & 3.10  & 2.95  & 6.03  & 1.00  \\ % 2.644   13.033
							   &                            & {\bf run-time (s)} & 11     & 24    & 49    & 196   & 1014  & 2759  & 6.8  \\                               
		
		\cmidrule{2-10}		                       
                               &\multirow{2}{*}{ $Gurobi$}  & $f$                & 7.78  & 3.94  & 3.17  & 3.10  & 2.95  & 6.03  & 1.00  \\ % 7.779   1.549
