...
\begin{table}[H]
	...
	\begin{tabular}{crcccccccc}
		...
		\toprule	
		\multirow{7}{*}{$1.2$}&$Relaxed$  & $f$                &{\it 12.23}&{\it 8.67} &{\it 12.67}&{\it 15.36}&{\it 16.29}&{\it 16.20}&  \specialcell{{\bf 1.00}} \\%  8142
		...
		\midrule		
		\multirow{7}{*}{$1.5$}&$Relaxed$  & $f$                &{\it 17.01}&{\it 12.45}&{\it 18.02}&{\it 22.03}&{\it 23.09}&{\it 22.35}&  \specialcell{{\bf 1.00}} \\%11495  
		&                       $MIP$     & {\it run time (s)} &     4     &     20    &     32    &     115   &     296  &     1685  &  1.00\\%					
        \cmidrule{2-10}		                       
		...
		\midrule
		\multirow{7}{*}{$2.0$}&$Relaxed$  & $f$                &{\it 24.56}&{\it 17.47}&{\it 25.19}&{\it 27.94}&{\it 29.90}&{\it 27.60 }&  \specialcell{{\bf 1.00}} \\%15266  
		&                       $MIP$     & {\it run time (s)} &          &         &         &        &        &       & 1.00\\%							
		\cmidrule{2-10}		                       
...
\color{blue}{	
	...
	\begin{tabular}{crcccccccc}
		...
		{\it surplus}    &{\it method}    & {\bf Results}      &{\bf 1}    &{\bf 2}    &{\bf 3}    &{\bf 4}    &{\bf 5}    &{\bf 6}    &{\bf Speedup} \\
		\toprule
		\multirow{7}{*}{$1.2$}&$Relaxed$  & $f$                &   11.47   &    7.24   &{\bf 10.78}&     12.06 &     12.97 &    12.44  &  \specialcell{{\bf 1.00}} \\%
		&                       $MIP$     & {\it run time (s)} &     6     &     25    &     41    &     158   &      401  &     2161  &  1.00\\%					
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}        & $f$                &    9.05   &   5.11    &   9.75    &   10.96   &   12.86   &   13.25   &  0.96 \\% 7817
		&                                 & {\it run time (s)} &     16    &     68    &     94    &    323    &    719    &    3549   &  1.00 \\% 439			
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}      & $f$                &{\bf 12.14}&{\bf 7.29} &   10.36   &{\bf 12.63}&{\bf 14.04}&{\bf 13.92}&  0.90\\% 7278
		&                                 & {\it run time (s)} &     9     &     36    &     54    &     192   &     427   &    2118   &  {\bf 2.80}\\%		
		\midrule		
		\multirow{7}{*}{$1.5$}&$Relaxed$  & $f$                &     15.83 &     10.08 &   15.14   &     16.87 &     18.58 &     17.52 &  \specialcell{{\bf 1.00}} \\%11495  
		&                      $MIP$      & {\it run time (s)} &    10     &     43    &     72    &     262   &     696   &     3741  &  1.00 \\% 439					
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}        & $f$                &   11.55   &   7.61    &   12.28   &   15.00   &   17.55   &   17.57    &  0.96  \\%  11012
		&                                 & {\it run time (s)} &    25     &    107    &     156   &    498    &    1217   &   5743     &  1.00 \\% 260
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}      & $f$                &   17.05   &   10.01   &   15.01   &   16.75   &   20.09   &   17.85   &  0.87 \\% 9966
		&                                 & {\it run time (s)} &    18     &    64     &     101   &    351    &   828     &  3879      &  {\bf 1.70}\\% 151
		\midrule
		\multirow{7}{*}{$2.0$}&$Relaxed$  & $f$                &     23.73 &           &           &           &           &            &  \specialcell{{\bf 1.00}} \\%15266  
		&                       $MIP$     & {\it run time (s)} &    14     &     3     &     5     &     20    &     58    &     352   &  1.00 \\% 439					
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $Shims$}        & $f$                &   16.28   &           &           &       &       &       &   0.96  \\%  14666
		&                                 & {\it run time (s)} &    37     &     2     &     4     &     14     &     35     &   220     &  1.00 \\% 260
		\cmidrule{2-10}		                       
		&\multirow{2}{*}{ $mpShims$}      & $f$                &   24.52   &           &           &       &       &          &  0.94  \\% 14374
		&                                 & {\it run time (s)} &    27     &     2     &     3     &     9      &   26       &  151      &  {\bf 1.70}\\% 151
		\bottomrule	
	\end{tabular}
	\normalsize
\end{table}
