...
\multirow{7}{*}{$1.2$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 12.00       & {\bf 8.38}  & {\bf 12.19} & 13.38       &  14.42      & 13.25        & 0.96 \\% 7651
&                                                & {\it run-time (s)} &  8          &   14        &  25         &  95         &    217      &  1719        & 1.0  \\%2078

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 8.37        &  6.40       &  7.68       &  8.05       &   7.72      & 6.74         & 0.56 \\%
&                                                & {\it run-time (s)} &  < 1        &  < 1        &    3        &   11        &   27        &  342         & 5.4   \\%385

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 12.24} &  7.95       &  11.59      & {\bf 13.80} & {\bf 16.16} & {\bf 13.74}  & {\bf 0.99} \\%
&                                                & {\it run-time (s)} &  < 1        &  < 1        &    2        &   6         &    15       &   165        & {\bf 10.9}  \\% 190

\midrule

\multirow{7}{*}{$1.5$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 16.49       & {\bf 11.60} & {\bf 16.68} & 18.33       &  20.10      & 17.94        & 0.97  \\%10402
&                                                & {\it run-time (s)} &  12         &   25        &  45         &  169        &   437       &  2377        & 1.0  \\%3065

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 12.53       &  8.31       &  10.04      &  10.94      &   11.72     & 10.13        & 0.61 \\%
&                                                & {\it run-time (s)} &  < 1        &  3          &    6        &   24        &   70        &  419         & 5.9 \\%523

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 16.71} & 10.86       & {\bf 16.68} & {\bf 18.84} & {\bf 21.30} & {\bf 19.39}  & {\bf 1.00}  \\%
&                                                & {\it run-time (s)} &  < 1        &  2          &    3        &   9         &   26        &   158        & {\bf 15.4}  \\%199

\midrule
\multirow{7}{*}{$2.0$}&\multirow{2}{*}{ $Gurobi$}& $f$                & 24.04       & {\bf 17.33} & 24.62       & {\bf 26.36} &  28.88      & 25.89        & 0.98  \\%14962
&                                                & {\it run-time (s)} &  14         &   34        &  62         &  236        &   609       & 3431         & 1.0  \\%4386

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                       & $f$                & 18.41       &  13.37       &  15.90      &  16.17      &   17.08     & 15.96        & 0.65 \\%
&                                                & {\it run-time (s)} &  < 1        &  4          &    7        &   30         &   85        &  501         & 7.0 \\%628

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                     & $f$                & {\bf 24.28} & 16.54       & {\bf 25.53} & 25.87        & {\bf 29.10} & {\bf 27.02}  & {\bf 0.99} \\%
&                                                & {\it run-time (s)} &  < 1        &  2          &    3        &   12         &   32        &   188        & {\bf 18.4}  \\%238
...
Let $Q  = \{ a^{\pi(k_1)}, a^{\pi(k_2)}, \ldots, a^{\pi(k_{m})} \}$ be the set of consolidated items assembled on the set of $m$ pallets in node $\pi(k)$.
...
As the number of pallets was small for an integer program solver, the increased time was negligible.

Columns {\bf Before} and {\bf After} on Table \ref{tab:distRampDoor} refer to the application of the integer programming solver according to equations \ref{eq:distobj} to \ref{eq:disttorque}.

\vspace{2.0mm}

\begin{table}[H]
\centering
\caption{Distance from ramp door minimization}  \label{tab:distRampDoor}
\footnotesize
%\scriptsize
\begin{tabular}{cccc}
\toprule

{\bf Surplus} & {\bf Scenario} & {\bf Before (m)} & {\bf After (m)} \\
\midrule
\multirow{6}{*}{$1.2$}&1 & 7.07 & 7.07 \\
&                     2 & 41.23 & 37.52 \\
&                     3 & 24.03 & 24.64 \\
&                     4 & 26.84 & After \\
&                     5 & Before & After \\
