...
Observing Figure \ref{fig:mpShimsData20}, it may be noticed that the best number of processes for {\it Scenario 1} (closest to the upper left corner) is 8. For {\it Scenario 2}, the best number is 16.
...
Observing Figure \ref{fig:mpShimsData50}, it may be noticed that the best number of processes for {\it Scenario 1} (closest to the upper left corner) is 8. For {\it Scenario 2}, the best number is 16.
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {Shims_p1data100.csv};
		...
		\begin{tikzpicture}[scale=0.8, samples=100]
			\begin{axis}[
				...
				table[x=time, y=score, col sep=comma] {Shims_p2data100.csv};
				
				\legend{\it parallel processes}
			\end{axis}
		\end{tikzpicture}
		
		\caption{{\it mpShims} performance with $2.0 \times volume$.}
	\end{center}
	\label{fig:mpShimsData100}
\end{figure}

Observing Figure \ref{fig:mpShimsData100}, it may be noticed that the best number of processes for {\it Scenario 1} (closest to the upper left corner) is 8. For {\it Scenario 2}, the best number is 16.
