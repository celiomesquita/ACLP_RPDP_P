...
\multirow{6}{*}{$1.2$} &\multirow{2}{*}{ Gurobi}& $f$                & {\bf 9.75} &  6.34     &  7.61       &   7.43     &  7.43     &       &   \\%
&                                               & {\bf run-time (s)} &  8         &   17      &  30         &  114       &    315   &       &   \\%

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $Shims$}                      & $f$                & 7.13       &  4.67     &  4.55       &  3.89      &  3.30     &       &   \\%
&                                               & {\bf run-time (s)} &  < 1       &   2       &    4        &   13       &   38    &       &   \\%

\cmidrule{2-10}		                       
&\multirow{2}{*}{ $mpShims$}                    & $f$                & 9.30       & {\bf 6.47} & {\bf 7.73} & {\bf 7.46} &  {\bf 7.53}     &       &   \\%
&                                               & {\bf run-time (s)} &  < 1       &   2        &    3       &  10        &    27   &       &   \\%
...
\end{tabular}
%\textsuperscript{$Gurobi^*$ was run with a time limit of 60s per node.}	
\normalsize
\end{table}

$Gurobi^*$ was run with a time limit of 60s per node. The remaining methods were run with a time limit of 1.6s per node, the worst time {\it Shims} took to solve a node.
