...
\subsection{Results before 3D packing}
...
\begin{table}[H]
	...
	\begin{tabular}{crcccccccc}
		...
		\midrule		
		\multirow{6}{*}{$1.5$}&$Relaxed$  & $f$                &{\it 17.01}&{\it 12.45}&{\it 18.02}&{\it 22.03}&{\it 23.09}&{\it 22.35}&  \specialcell{{\bf 1.00}} \\%11495  
		...
		\midrule
		\multirow{6}{*}{$2.0$}&$Relaxed$  & $f$                &{\it 24.56}&{\it 17.47}&{\it 25.19}&{\it 27.94}&{\it 29.90}&{\it 27.60 }&  \specialcell{{\bf 1.00}} \\%15266  
		&                       $MIP$     & {\it run time (s)} &     6     &     25    &     41    &     158   &      401  &     2161  & 1.00\\%							
		\cmidrule{2-10}		                       
...
\subsection{Results after 3D packing}
...
\color{blue}{	
	...
	\begin{tabular}{crcccccccc}
		...
		{\it surplus}    &{\it method}    & {\bf Results}      &{\bf 1}    &{\bf 2}    &{\bf 3}    &{\bf 4}    &{\bf 5}    &{\bf 6}    &{\bf Speedup} \\
		\toprule
		\multirow{6}{*}{$1.2$}&$Relaxed$  & $f$                &{\it 11.47}&{\it 7.24} &{\it 10.78}&{\it 12.06}&{\it 12.97}&{\it 12.44}&  \specialcell{{\bf 1.00}} \\%
		&                       $MIP$     & {\it run time (s)} &     6     &     25    &     41    &     158   &      401  &     2161  &  1.00\\%					
		\cmidrule{2-10}		                       
		...
		\midrule		
		\multirow{6}{*}{$1.5$}&$Relaxed$  & $f$                &{\it 15.83}&{\it 10.08}&{\it 15.14}&{\it 16.87}&{\it }&{\it }&  \specialcell{{\bf 1.00}} \\%11495  
		&                      $MIP$      & {\it run time (s)} &    10     &     43    &     72    &     262   &     58    &     352   &  1.00 \\% 439					
		\cmidrule{2-10}		                       
		...
		\midrule
		\multirow{6}{*}{$2.0$}&$Relaxed$  & $f$                &{\it 23.73}&{\it }&{\it }&{\it }&{\it }&{\it  }&  \specialcell{{\bf 1.00}} \\%15266  
