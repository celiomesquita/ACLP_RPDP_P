...
Table \ref{tab:numProcs} presents the best numbers of parallel processes for each method, scenario, and volume surplus. As all numbers are less than or equal to 8, any hand-held computer with 8 cores can yield efficient solutions.
...
\footnotesize
%\scriptsize
\begin{tabular}{rccccccc|c}
\toprule
                                &                &\multicolumn{6}{c}{\bf Scenarios} &\\
\cmidrule{3-8}		
{$method$}                      &{\bf Results}   &{\bf 1}&{\bf 2}&{\bf 3}&{\bf 4}&{\bf 5}&{\bf 6}&\specialcell{{\bf Normalized}\\{\bf Speed-up}} \\
\toprule
\multirow{2}{*}{\it {mpShims}} & $f$              & 5.88 & 3.16    & 3.16 &      &      &      &   \\ 
                               &{\bf run-time (s)}& 1    & 10      & 41   &      &      &      &   \\
\midrule

\multirow{2}{*}{\it {mpACO}}   & $f$              & 5.82 & 3.12    &      &      &      &      &   \\ 
