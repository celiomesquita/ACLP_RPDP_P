...
from py3Djanet.constants import RotationType
from py3Djanet.methods import intersect, set_to_decimal, DEFAULT_NUMBER_OF_DECIMALS

class Bin:
    def __init__(self, size, length, width, height, capacity, id):
        self.ID = id
        self.size = size
        self.length = length
        self.width = width
