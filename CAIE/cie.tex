...
\begin{table}[H]
	...
	\begin{tabular}{ccc|ccc|ccc|ccc}
		...
		\midrule
		$method$& {\bf \specialcell{Time\\limit (s)}} & {\bf Scenarios}&{\bf 3}&{\bf 4}&{\bf 5}&{\bf 3}&{\bf 4}&{\bf 5}&{\bf 3}&{\bf 4}&{\bf 5} \\
		\toprule
		
		\multirow{8}{*}{\it Gurobi } & \multirow{2}{*}{240*} & $f$ &       &         &         &       &         &         &       &        &  \\ % 
&               &  {\bf run time (s)}                              &       &         &         &       &         &         &       &        &  \\ % 
\cmidrule(lr){2-12}		
		...
		\cmidrule(lr){2-12}                              
		& \multirow{2}{*}{2400}& $f$                               & 13.30 & 14.59   & 13.59   & 18.25 &  20.60  &  x      &       & 29.10   & x \\ % 
		&        &  {\bf run time (s)}                             & 127   & 313     & 1444    & 188   &  327    &  x      &       & 543     & x \\ % 
		\cmidrule(lr){2-12}                              		
		...
		\midrule
		 ...
		 \multirow{2}{*}{\it Shims} & \multirow{2}{*}{240*}  & $f$ & 13.23 & 14.53   & 13.42   &       &  20.45  & 18.00   &       & 28.98   & 26.08 \\ % 
		&         & {\bf run time (s)}                             & 6     & 17      & 109     &       &  26     & 160     &       & 37      & 229   \\ % 
				
		\bottomrule
		
		&                                       & {\bf Normalized} & 0.99  & 0.99    & 0.99    &       & 0.99    & 0.98    & & 1.00    & x\\
		&                                       & {\bf Speed-up}   & 20.9  & 15.6    & 13.5    &       & 14.3    & 14.3    & & 16.3    & x\\
