...
The results obtained with $time = 3600s$, which is the highest tested time limit, are in Tables \ref{tab:20}, \ref{tab:50} and \ref{tab:100}, with $surplus$\/ values $1.2$, $1.5$\/ and $2.0$, respectively. We indicate with an {\bf x} the cases where $Gurobi$\/ did not find a feasible solution within this time limit, or had to be aborted due to high RAM consumption.


\begin{table}[H]
	\centering
	\caption{Solutions with $surplus = 1.2$\/ and $time =  3600s$}  \label{tab:20}
	\footnotesize
	\begin{tabular}{ccccccccc}
		\toprule
		{\specialcell{{\bf Tested}\\{\bf tours}}}&$method$          & {\bf Scenarios} & {\bf 1} & {\bf 2} & {\bf 3} & {\bf 4} & {\bf 5} & \specialcell{{\bf Normalized}\\{\bf Speed-up}}   \\
		\toprule
		\multirow{4}{*}{Shortest} &\multirow{2}{*}{\it Gurobi } & $f$ & 8.52    & 11.70   & 13.07   & 13.54 & 12.44     &  1.00\\ % 5927
		&                                                               &               {time (s)}  & 17      & 17      & 16      & 17    & 26        &  1.0 \\ % 93
		\cmidrule(lr){2-9}	
		&                                                               \multirow{2}{*}{\it Shims}    & $f$ & 8.54    & 11.63   & 12.97   & 13.43 & 12.36     &  0.99 \\ % 5893
		&                                                               &         {time (s)}        & 1       & 1       & 2       & 2     & 2         &  11.6 \\ % 8
		
		\midrule
		
		\multirow{4}{*}{All $K!$}&                                  \multirow{2}{*}{\it Gurobi } & $f$ & 8.52    & 12.25   & 13.32   & 14.61  & x        & 1.00 \\ % 4869
		&                                                               &               {time (s)}  & 25      & 36      & 121     & 297    & x        &  1.0 \\ % 479
		\cmidrule(lr){2-9}	
		&                                                               \multirow{2}{*}{\it Shims}    & $f$ & 8.54    & 12.26   & 13.23   & 14.53  & 13.42    & 0.99  \\ % 4813
		&                                                               &         {time (s)}        & 1       & 2       & 6       & 17     & 106      & 18.4   \\ % 132
		\bottomrule
...
\begin{table}[H]
	\centering
	\caption{Solutions with $surplus = 1.5$\/ and $time =  3600s$}  \label{tab:50}
	\footnotesize
	\begin{tabular}{ccccccccc}
		\toprule
		{\specialcell{{\bf Tested}\\{\bf tours}}} & $method$          & {\bf Scenarios} & {\bf 1} & {\bf 2} & {\bf 3} & {\bf 4} & {\bf 5} & \specialcell{{\bf Normalized}\\{\bf Speed-up}}   \\
		\toprule
		\multirow{4}{*}{ Shortest } & \multirow{2}{*}{\it Gurobi } & $f$ & 11.80 & 16.74 & 18.04 & 18.86 & 16.92 & 1.00 \\ % 8236
		&&               {time (s)}                                                                  & 38    & 30    & 27    & 29    & 81    & 1.00  \\ % 205
		\cmidrule(lr){2-9}	
		...
		\multirow{4}{*}{All $K!$} & \multirow{2}{*}{\it Gurobi }                                  & $f$ & 11.81 & 17.01 & 18.25 & 20.59 & 18.36   & 1.00 \\ % 8602
		&&               {time (s)}                                                                  & 53    & 61    & 193   & 470   & 2241    & 1.0  \\ % 3018
		\cmidrule(lr){2-9}	
		&\multirow{2}{*}{\it Shims}                                                                    & $f$ & 11.83 & 17.00 & 18.21 & 20.45 & 18.00   & 0.99  \\ % 8549
		&&         {time (s)}                                                                        & 1     & 2     & 9     & 26    & 157     & 15.5 \\ % 195
		\bottomrule
...
\begin{table}[H]
	\centering
	\caption{Solutions with $surplus = 2.0$\/ and $time =  3600s$}  \label{tab:100}
	\footnotesize
	\begin{tabular}{ccccccccc}
		\toprule
		{\specialcell{{\bf Tested}\\{\bf tours}}}& $method$          & {\bf Scenarios} & {\bf 1} & {\bf 2} & {\bf 3} & {\bf 4} & {\bf 5} & \specialcell{{\bf Normalized}\\{\bf Speed-up}}   \\
		\toprule
		\multirow{4}{*}{ Shortest} & \multirow{2}{*}{\it Gurobi } & $f$ & 17.75 & 24.39 & 26.46 & 27.09 & 24.00 & 1.00 \\ % 11969
		&&                                                                               {time (s)}  & 162   & 95    & 74    & 68    & 67    & 1.0  \\ % 466
		\cmidrule(lr){2-9}	
		&                                                                   \multirow{2}{*}{\it Shims} & $f$ & 17.78 & 24.40 & 26.36 & 27.01 & 23.94 & 0.99  \\ % 11949
		&&                                                                                {time (s)} & 2     & 3     & 3     & 4     & 5     & 27.4  \\ % 17
		
		\midrule
		
		\multirow{4}{*}{All $K!$} & \multirow{2}{*}{\it Gurobi } & $f$ & 17.75 & 25.24 & 26.46 & 29.11 &  x   & 1.00 \\ % 9856
		&&                                                                                {time (s)} & 151   & 123   & 319   & 689   &  x   & 1.0  \\ % 1282
		\cmidrule(lr){2-9}	
		&                                                                \multirow{2}{*}{\it Shims}    & $f$ & 17.78 & 25.25 & 26.38 & 28.98 & 26.08 & 1.00  \\ % 9839
		&&                                                                                {time (s)} & 2     & 3     & 13    & 37    & 229   & 23.3  \\ % 284
		\bottomrule
...
\begin{table}[H]
	\centering
	\caption{Solutions in scenarios 4 and 5 testing all $K!$\/ tours}  \label{tab:100time}
	\footnotesize
	\begin{tabular}{ccc|cc|cc|cc}
		\toprule
		&             \multicolumn{2}{c}{$surplus$} &\multicolumn{2}{c}{$1.2$}&\multicolumn{2}{c}{$1.5$}&\multicolumn{2}{c}{$2.0$} \\
		\midrule
		$method$& {\specialcell{$time$ (s)}} & {\bf Scenarios}    & {\bf 4} & {\bf 5} & {\bf 4} & {\bf 5} & {\bf 4} & {\bf 5} \\
		\toprule
		
		\multirow{6}{*}{\it Gurobi }& \multirow{2}{*}{1200} & $f$ & 14.67   & x       &  20.64  &  x      & 27.97   & x \\ % 
		&        &  {time (s)}                             & 217     & x       &  304    &  x      & 579     & x \\ % 
		\cmidrule(lr){2-9}                              
		& \multirow{2}{*}{2400}& $f$                               & 14.59   & 13.59   &  20.60  &  x      & 29.10   & x \\ % 
		&        &  {time (s)}                             & 313     & 1444    &  327    &  x      & 543     & x \\ % 
		\cmidrule(lr){2-9}                              		
		& \multirow{2}{*}{3600}& $f$                               & 14.61   & x       &  20.59  & 18.36   & 29.11   & x \\ % 
		&        &  {time (s)}                             & 297     & x       &  470    & 2241    & 689     & x \\ % 		
		\midrule
		\multirow{6}{*}{\it Shims}   & \multirow{2}{*}{1200} & $f$ & 14.53   & 13.42   &  20.45  & 18.00   & 28.98   & 26.08 \\ % 
		&        & {time (s)}                              & 18      & 109     &  26     & 160     & 37      & 203   \\ % 
		\cmidrule(lr){2-9}                              
		& \multirow{2}{*}{2400}& $f$                               & 14.53   & 13.42   &  20.45  & 18.00   & 28.98   & 26.08 \\ % 
		&        &  {time (s)}                             & 18      & 107     &  25     & 159     & 37      & 192   \\ % 	
		\cmidrule(lr){2-9}                              
		& \multirow{2}{*}{3600} & $f$                              & 14.53   & 13.42   &  20.45  & 18.00   & 28.98   & 26.08 \\ %  
		&        &  {time (s)}                             & 17      & 106     &  26     & 157     & 37      & 181   \\ 
...
\scriptsize	
	...
	\begin{tabular}{ccc|ccccc|ccccc|ccccc}
		\toprule
		&             \multicolumn{2}{r}{\bf Volume $surplus$} &\multicolumn{5}{c}{$1.2$}&\multicolumn{5}{c}{$1.5$}&\multicolumn{5}{c}{$2.0$} \\
		\midrule
		$method$& \specialcell{\bf limit\\ (s)} & {\bf Scenarios}  &{\bf 1}&{\bf 2}&{\bf 3}&{\bf 4}&{\bf 5}&{\bf 1}&{\bf 2}&{\bf 3}&{\bf 4}&{\bf 5}&{\bf 1}&{\bf 2}&{\bf 3}&{\bf 4}&{\bf 5} \\
		\toprule
		
		\multirow{10}{*}{\it Gurobi } & \multirow{2}{*}{240*} & $f$ & 8.53 & 12.24 & 13.34 &  x      &  x      & 11.81 & 17.02 & 18.31 &  x      &  x      & 17.75 & 25.24 & x     & x       & x \\ % 
		&               &  {\bf time (s)}                              & 41   & 43    & 123   &  x      &  x      & 50    & 62    & 181   &  x      &  x      & 166   & 140   & x     & x       & x \\ % 
		\cmidrule(lr){2-18}		
		
		&                              \multirow{2}{*}{1200} & $f$ & 8.52 & 12.25 & 13.31 & 14.67   & x       & 11.81 & 17.02 & 18.25 &  20.64  &  x      & 17.75 & 25.24 & 26.49 & 27.97   & x \\ % 
		&        &  {\bf time (s)}                             & 39   & 41    & 129   & 217     & x       & 52    & 61    & 190   &  304    &  x      & 161   & 139   & 384   & 579     & x \\ % 
		\cmidrule(lr){2-18}                              
		& \multirow{2}{*}{2400}& $f$                               & 8.53 & 12.25 & 13.30 & 14.59   & 13.59   & 11.80 & 17.02 & 18.25 &  20.60  &  x      & 17.75 & 25.24 & 26.46 & 29.10   & x \\ % 
		&        &  {\bf time (s)}                             & 33   & 39    & 127   & 313     & 1444    & 51    & 62    & 188   &  327    &  x      & 158   & 127   & 381   & 543     & x \\ % 
		\cmidrule(lr){2-18}                              		
		
		& \multirow{2}{*}{3600}& $f$                               & 8.52 & 12.25 & 13.32 & 14.61   & x       & 11.81 & 17.01 & 18.25 &  20.59  & 18.36   & 17.75 & 25.24 & 26.46 & 29.11   & x \\ % 
		&        &  {\bf time (s)}                             & 25   & 36    & 121   & 297     & x       & 53    & 61    & 193   &  470    & 2241    & 151   & 123   & 319   & 689     & x \\ % 		
		
		\midrule
		
		\multirow{2}{*}{\it Shims} & \multirow{2}{*}{240*}    & $f$ & 8.54 & 12.26 & 13.23 & 14.53   & 13.42  & 11.83 & 17.00 & 18.21 &  20.45  & 18.00   & 17.78 & 25.25 & 26.38 & 28.98   & 26.08 \\ % 
		&         & {\bf time (s)}                                  & 1    & 2     & 6     & 17      & 109    & 1     & 2     & 8     &  26     & 160     & 2     & 3     & 13    & 37      & 229   \\ % 
		
		\multirow{2}{*}{\it mpShims} & \multirow{2}{*}{240*}  & $f$ & 8.32 & 12.14 & 13.19 & 14.60   & 13.52  & 11.57 & 16.86 & 18.21 & 20.52   & 18.06  & 17.58 & 25.21 & 26.46 & 29.11   & 26.14 \\ % 
&         & {\bf time (s)}                                          & 1    & 2     & 5     & 13      & 71     & 1     & 2     & 6     & 15      & 79     & 2     & 2     & 8     & 21      & 102   \\ % 
		
		\bottomrule
		\multicolumn{16}{l}{*4 minutes is the time {\it Shims} needs to solve a seven-node tour.}\\
	\end{tabular}
	\normalsize
\end{table}
...
\begin{figure}[H]
	\centering
	\tmpframe{\includegraphics[scale=0.5]{Images/mpShimsResouces.png}}
	\captionof{figure}{{\it mpShims} resources consumption}
	\label{fig:mpShimsResouces}
\end{figure}
