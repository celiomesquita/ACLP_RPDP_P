...
\begin{table}[H]
	...
	\begin{tabular}{ccccccccc}
		...
		\cmidrule(lr){2-9}	
		&                                                                   \multirow{2}{*}{\it Shims} & $f$ & 16.48 & 24.06 & 26.15 & 26.25 & 23.54 &  0.97 \\ % 116,48
		&&                                                                                {\bf run time (s)} & 5     & 6     & 8     & 10    & 11    &  11.7  \\ % 40
		
		\midrule
		
		                                 \multirow{4}{*}{\it $S_{K}$ } & \multirow{2}{*}{\it Gurobi* } & $f$ & 17.75 & 25.24 & 26.46 & 29.11 &     &  \\ % 
		&&                                                                                {\bf run time (s)} & 151   & 123   & 319   & 689   &     &   \\ % 
		\cmidrule(lr){2-9}	
		&                                                                \multirow{2}{*}{\it Shims}    & $f$ & 16.35 & 24.30 & 26.24 & 28.65 & 28.74   &   \\ % 
		&&                                                                                {\bf run time (s)} & 5     & 9     & 37    & 108   & 625     &   \\ % 
		\bottomrule
...
\begin{table}[H]
\centering
\caption{Solutions with volume {\color{red}$surplus=1.2$} with different time limitations for $S_K$ tours.}  \label{tab:20time}
\footnotesize
\begin{tabular}{ccccccccc}
\toprule
...
\multirow{6}{*}{\it Gurobi* }& \multirow{2}{*}{1200} & $f$ & 8.53 &    &    &    & x   &  \\ % 
                             &        &  {\bf run time (s)}& 29   &       &       &       & x   &   \\ % 
\cmidrule(lr){2-9}                              
                             & \multirow{2}{*}{2400}& $f$  & 8.53 & 12.25 & 13.31 & 14.59  & 13.59   &  \\ % 
                             &        &  {\bf run time (s)}& 29   & 40    & 129   & 313    & 1460   &   \\ % 
\cmidrule(lr){2-9}                              		
                             & \multirow{2}{*}{3600}& $f$  & 8.51 & 12.25 & 13.32 & 14.61 & x   & 1.00 \\ % 4869
                             &        &  {\bf run time (s)}& 25   & 36    & 121   & 297   & x   & 1.0 \\ % 479		
\midrule
...
\cmidrule(lr){2-9}                              
                             ...
                             &        &  {\bf run time (s)}&    &    &    &    &    &   \\ % 	
\cmidrule(lr){2-9}                              
                             & \multirow{2}{*}{3600} & $f$ & 8.11 & 12.18 & 13.25 & 14.57 & 14.33 & 0.99 \\ % 4811 
                             &        &  {\bf run time (s)}& 4    & 8     & 33    & 95    & 572   & 3.4  \\ % 140 	                                        
\bottomrule
...
\begin{table}[H]
	\centering
	\caption{Solutions with volume {\color{blue}$surplus=1.5$} with different time limitations for $S_K$ tours.}  \label{tab:50time}
	\footnotesize
	\begin{tabular}{ccccccccc}
		\toprule
		$method$  & {\bf \specialcell{Time\\limit (s)}} & {\bf Scenarios} & {\bf 1} & {\bf 2} & {\bf 3} & {\bf 4} & {\bf 5} & \specialcell{{\bf Normalized}\\{\bf Speed-up}}\\
		...
		&        &  {\bf run time (s)}&    &    &    &    &    &   \\ % 
		\cmidrule(lr){2-9}                              		
		& \multirow{2}{*}{3600}& $f$  & 11.81 & 17.01 & 18.25 & 20.59 & 18.36   & 1.00 \\ % 8602
		&        &  {\bf run time (s)}& 53    & 61    & 193   & 470   & 2241    & 1.0  \\ % 3018		
		\midrule
		\multirow{6}{*}{\it Shims}   & \multirow{2}{*}{1200} & $f$ &    &    &    &    &    &   \\ % 
		&        & {\bf run time (s)} &    &    &    &    &    &   \\ % 
		...
		&        &  {\bf run time (s)}&    &    &    &    &    &   \\ % 	
		\cmidrule(lr){2-9}                              
		& \multirow{2}{*}{3600} & $f$ & 11.33 & 16.97 & 17.56 & 20.43 & 17.94   & 0.98  \\ % 8423 
		&        &  {\bf run time (s)}& 4     & 8     & 34    & 96    & 591     & 4.1 \\ % 733 	                                        
		\bottomrule
...
\begin{table}[H]
	\centering
	\caption{Solutions with volume {\color{violet}$surplus=2.0$} with different time limitations for $S_K$ tours.}  \label{tab:100time}
	\footnotesize
	\begin{tabular}{ccccccccc}
		\toprule
		$method$  & {\bf \specialcell{Time\\limit (s)}} & {\bf Scenarios} & {\bf 1} & {\bf 2} & {\bf 3} & {\bf 4} & {\bf 5} & \specialcell{{\bf Normalized}\\{\bf Speed-up}}\\
		...
		&        &  {\bf run time (s)}&    &    &    &    &    &   \\ % 
		\cmidrule(lr){2-9}                              		
		& \multirow{2}{*}{3600}& $f$  & 17.75 & 25.24 & 26.46 & 29.11 &    &  \\ % 
